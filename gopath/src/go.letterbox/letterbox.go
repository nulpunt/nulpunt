/* Pacakge letterbox
 * Manages a queue of documents that will be OCR'ed.
 *
 * Copyright, 2013, by: Guido Witmond (guido@witmond.nl)
*/

package main // letterbox
...
func ProcessDocument(que *Queue, doc *Document) {
	...
	if parserr != nil {
		...
		if err != nil { panic(err) }  // double error, panic
	}
